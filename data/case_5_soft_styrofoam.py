...
input_files_dir = "./outputs/soft_files_styrofoam"
results_dir = "output"
...
model.add_soil_layer_by_coordinates(deep_wall_part_1_coordinates, material_styrofoam, "deep_wall_part_1")
model.add_soil_layer_by_coordinates(deep_wall_part_2_coordinates, material_styrofoam, "deep_wall_part_2")
model.add_soil_layer_by_coordinates(deep_wall_part_3_coordinates, material_styrofoam, "deep_wall_part_3")
