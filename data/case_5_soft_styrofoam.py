...
input_files_dir = "./data/case_5_soft_styrofoam/"
results_dir = "output"
...
model.add_soil_layer_by_coordinates(
    deep_wall_part_1_coordinates, material_styrofoam, "deep_wall_part_1"
)
model.add_soil_layer_by_coordinates(
    deep_wall_part_2_coordinates, material_styrofoam, "deep_wall_part_2"
)
model.add_soil_layer_by_coordinates(
    deep_wall_part_3_coordinates, material_styrofoam, "deep_wall_part_3"
)
...
model.add_output_settings_by_coordinates(
    ...
    "case_5_soft_styrofoam_json_output",
)
