...
# fill in PSS parameters, assumed 10x stiffer than ballast and about 5x stiffer than very stiff sand
soil_formulation_pss = OnePhaseSoil(ndim, IS_DRAINED=True, DENSITY_SOLID=2000, POROSITY=0.0)
constitutive_law_pss = LinearElasticSoil(YOUNG_MODULUS=1.5e9, POISSON_RATIO=poisson_ratio_undrained)
material_pss = SoilMaterial("pss", soil_formulation_pss, constitutive_law_pss, SaturatedBelowPhreaticLevelLaw())
...
model.add_soil_layer_by_coordinates(foundation_coordinates_top, material_pss, "foundation_top") #pss added
...
# Set up problem data
problem = Problem(problem_name="stiff", number_of_threads=10,
