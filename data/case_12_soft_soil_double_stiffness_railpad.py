...
input_files_dir = "./data/case_12_soft_soil_double_stiffness_railpad/"
results_dir = "output"
...
rail_pad_parameters = ElasticSpringDamper(
    NODAL_DISPLACEMENT_STIFFNESS=[0, 1500e6, 0],
...
model.add_output_settings_by_coordinates(
    ...
    "json_output_case_12_soft_soil_double_stiffness_railpad",
)
