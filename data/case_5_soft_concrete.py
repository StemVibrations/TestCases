...
input_files_dir = "./data/case_5_soft_concrete/"
results_dir = "output"
...
soil_formulation_concrete = OnePhaseSoil(
    ndim, IS_DRAINED=True, DENSITY_SOLID=2350, POROSITY=0.0
)
...
model.add_soil_layer_by_coordinates(
    deep_wall_part_1_coordinates, material_concrete, "deep_wall_part_1"
)
model.add_soil_layer_by_coordinates(
    deep_wall_part_2_coordinates, material_concrete, "deep_wall_part_2"
)
model.add_soil_layer_by_coordinates(
    deep_wall_part_3_coordinates, material_concrete, "deep_wall_part_3"
)
...
model.add_output_settings_by_coordinates(
    ...
    "case_5_soft_concrete_json_output",
)
