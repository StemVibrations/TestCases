...
input_files_dir = "./data/case_16_soft/"
results_dir = "output"
...
json_output_parameters = JsonOutputParameters(
    delta_time_json - 1e-10, [NodalOutput.VELOCITY], []
)
model.add_output_settings_by_coordinates(
    [
        (x_coord_deep_wall + thickness_deep_wall, surface_level, 45.0),
        (25, surface_level, 45.0),
        (max_x_coordinate, surface_level, 45),
    ],
    json_output_parameters,
    "json_output_case_16_soft",
)
...
time_integration = TimeIntegration(
    ...
    reduction_factor=1,
    increase_factor=1,
    max_delta_time_factor=maxfactor,
)
...
# Set up problem data
problem = Problem(
    problem_name="soft_soil", number_of_threads=16, settings=solver_settings
)
...
stage2.project_parameters.settings.rayleigh_k = 1.04e-4
