...
poisson_ratio_drained = 0.3

soil_formulation_clay = OnePhaseSoil(ndim, IS_DRAINED=True, DENSITY_SOLID=1500, POROSITY=0.0)
constitutive_law_clay = LinearElasticSoil(YOUNG_MODULUS=50e6, POISSON_RATIO=poisson_ratio_drained)
...
constitutive_law_peat = LinearElasticSoil(YOUNG_MODULUS=100e6, POISSON_RATIO=poisson_ratio_drained)
...
constitutive_law_sand = LinearElasticSoil(YOUNG_MODULUS=350e6, POISSON_RATIO=poisson_ratio_drained)
...
constitutive_law_styrofoam = LinearElasticSoil(YOUNG_MODULUS=5e6, POISSON_RATIO=poisson_ratio_drained)
...
soil_formulation_water_in_ditch = OnePhaseSoil(ndim, IS_DRAINED=True, DENSITY_SOLID=10, POROSITY=0.0)
constitutive_law_water_in_ditch = LinearElasticSoil(YOUNG_MODULUS=young_modulus_water_in_ditch, POISSON_RATIO=0.0)
