...
input_files_dir = "soft_files_dir_100"
results_dir = "output"
...
uvec_load = MovingLoad(load=[0,-155000,0],direction=[1,1,1], velocity = 0.0, origin=[0.7, 2.6 + rail_pad_thickness, -45])
...
# Set up problem data
problem = Problem(problem_name="soft", number_of_threads=10,
...
velocity = 27.8 - 1e-5 # 140 km/h minus a small value to prevent numerical issues (solved in upcoming version)
