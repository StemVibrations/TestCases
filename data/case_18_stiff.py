...
input_files_dir = "./data/case_18_stiff/"
results_dir = "output"
...
# uvec_load = UvecLoad(direction_signs=[1,1,1], velocity = 0.0, origin=[0.7, top_ballast + rail_pad_thickness, -43],
...
# 100 km/h minus a small value to prevent numerical issues (solved in
# upcoming version)
velocity = 38.9 - 1e-5
for i, d in enumerate(wheel_configuration):
