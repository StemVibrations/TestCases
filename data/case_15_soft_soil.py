...
input_files_dir = "./data/case_15_soft_soil/"
results_dir = "output"
...
constitutive_law_embankment = LinearElasticSoil(
    YOUNG_MODULUS=200e6, POISSON_RATIO=0.3
)  # (YOUNG_MODULUS=100e6, POISSON_RATIO=0.3)
