...
constitutive_law_embankment = LinearElasticSoil(YOUNG_MODULUS=200e6, POISSON_RATIO=0.3) #(YOUNG_MODULUS=100e6, POISSON_RATIO=0.3)
...
model.add_output_settings_by_coordinates([(x_coordinate_end_ditch, surface_level, 45.0), (25, surface_level, 45.0), (max_x_coordinate,surface_level,45)],
                                         json_output_parameters, "case_15_json_output")
