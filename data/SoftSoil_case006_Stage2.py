...
input_files_dir = "./data/SoftSoil_case006_Stage2/"
results_dir = "output"
...
uvec_parameters = {
    ...
    # stiffness between the wheel and the bogie [N/m], primary
    # stiffness connects the wielstellen en draaistelframe,
    # default value is 4800e3
    "wheel_stiffness": 2 * 4800e3,
