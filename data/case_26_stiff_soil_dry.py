...
# enable_writing_to_log_file(Path(input_files_dir)  /  "log_file.log")
...
constitutive_law_sand = LinearElasticSoil(YOUNG_MODULUS=200e6, POISSON_RATIO=poisson_ratio_drained)
