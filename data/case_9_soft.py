...
input_files_dir = './data/case_9_soft/'

results_dir = "output-stiff_soil-fast"

# "stiff_soil-fast" based on "stiff_soil" with speed increased from 38.9 m/s to 44.4 m/s (from 140 to 160 km/h)
