...
input_files_dir = "./data/case_11_pss_on_stiff_soil/"

results_dir = "output_stiff_soil_pss"
...
constitutive_law_sand = LinearElasticSoil(
    YOUNG_MODULUS=200e6, POISSON_RATIO=poisson_ratio_undrained
)
...
soil_1_coordinates = (
    [
        (
            0.0,
            surface_level - thickness_foundation_bottom - thickness_foundation_top,
            0.0,
        ),
        (
            2.5,
...
soil_equivalent_parameters = ElasticSpringDamper(
    NODAL_DISPLACEMENT_STIFFNESS=[0, 110e6, 0],
    NODAL_ROTATIONAL_STIFFNESS=[0, 0, 0],
