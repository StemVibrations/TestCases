...
input_files_dir = "stiff_files_dir_140_TW22"
...
uvec_load = MovingLoad(load=[0,-220000,0],direction=[1,1,1], velocity = 0.0, origin=[0.7, top_ballast + rail_pad_thickness, -45])
