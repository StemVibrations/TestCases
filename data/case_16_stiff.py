...
input_files_dir = './data/case_16_stiff/'
results_dir = "output"
...
# add the boundary conditions to the modelf
...
# Set up problem data
problem = Problem(
    problem_name="stiff_soil",number_of_threads=16, settings=solver_settings
)
