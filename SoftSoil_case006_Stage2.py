...
uvec_parameters = {"n_carts": 2, # number of carts [-]
                   ...
                   "wheel_stiffness": 2*4800e3, # stiffness between the wheel and the bogie [N/m], primary stiffness connects the wielstellen en draaistelframe, default value is 4800e3 
